...
import com.civicconnect.api.service.SubdistrictService;
...
public class SubdistrictController {
    ...
    private final SubdistrictService service;

    @GetMapping
    public ResponseEntity<List<SubdistrictDTO>> getAll(
        ...
        Page<SubdistrictDTO> result = service.findAll(q, stateName, districtName, pageable);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SubdistrictDTO> getById(@PathVariable Long id) {
    ...
    public ResponseEntity<SubdistrictDTO> findByLocation(
